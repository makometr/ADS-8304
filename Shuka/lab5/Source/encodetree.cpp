...
{
    /*
     * Функция записи дерева в строку. Принимает на вход указатель
     * на корень дерева, ссылку на строку-результат и уровень в дереве.
     *
...
{
    /*
     * Функция определения кодов символов по дереву кодирования, принимает на вход
     * указатель на корень и текст, возвращает строку-результат.
     *
