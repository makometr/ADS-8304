 ...
 */
void decode(const std::unordered_map<char, std::string>& result, std::fstream& coding_message, int i) {
	int lenght = 0;
	std::string coding_string = {};
	std::ofstream decode_message(std::string("decode_message_Static_Hafman") + std::to_string(i) + std::string(".txt"));
...
int use_static(int argc, char* argv[]) {
    for (int i = 1; i < argc; i++) {
        ...
        std::ofstream symbol_code(std::string("symbol_code_Static_Hafman") + std::to_string(i) + std::string(".txt"));
        std::fstream coding_message(std::string("code_message_Static_Hafman") + std::to_string(i) + std::string(".txt"), std::ios::out | std::ios::in | std::ios::trunc);
